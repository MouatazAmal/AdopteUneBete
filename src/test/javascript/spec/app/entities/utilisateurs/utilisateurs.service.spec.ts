...
describe('Service Tests', () => {
  describe('Utilisateurs Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Utilisateurs', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            dateNaissance: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should update a Utilisateurs', async () => {
        const returnedFromService = Object.assign(
          {
            numRue: 1,
            nomRue: 'BBBBBB',
      ...
      it('should return a list of Utilisateurs', async () => {
        const returnedFromService = Object.assign(
          {
            numRue: 1,
            nomRue: 'BBBBBB',
      ...
      it('should delete a Utilisateurs', async () => {
