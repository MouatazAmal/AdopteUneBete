...
public class UtilisateursResourceIT {
    ...
    public void setup() {
        ...
        final UtilisateursResource utilisateursResource = new UtilisateursResource(utilisateursRepository, userRepository);
    ...
    public void createUtilisateurs() throws Exception {
        ...
        assertThat(testUtilisateurs.getId()).isEqualTo(testUtilisateurs.getUser().getId());
    }
...
/*
    @Test
    @Transactional
    public void updateUtilisateursMapsIdAssociationWithNewId() throws Exception {
        // Initialize the database
        utilisateursRepository.saveAndFlush(utilisateurs);
        int databaseSizeBeforeCreate = utilisateursRepository.findAll().size();


        // Load the utilisateurs
